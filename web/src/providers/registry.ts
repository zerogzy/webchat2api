...
export const accountProviderDefinitions = [gptProvider, grokProvider, geminiProvider, catpawProvider, joycodeProvider] as const satisfies readonly AccountProviderDefinition[];
