...
from services.providers.base import CATPAW_PROVIDER, GEMINI_PROVIDER, GROK_PROVIDER, JOYCODE_PROVIDER, QODER_PROVIDER
...
def matched_account_tokens_by_identifiers(
    ...
    if provider not in {GEMINI_PROVIDER, GROK_PROVIDER, CATPAW_PROVIDER, JOYCODE_PROVIDER, QODER_PROVIDER} or not identifiers:
        return set()
    account_ids = {
