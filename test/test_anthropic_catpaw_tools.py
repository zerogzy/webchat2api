...
class AnthropicCatpawToolTests(unittest.TestCase):
    ...
    def test_tool_parser_keeps_catpaw_file_operations_compatible(self) -> None:
        cases = [
            ...
            ('<tool_calls><tool_name>Edit</file_path</arg_key><arg_value>/home/claude/api/app.py</arg_value><arg_key>old_string</arg_key><arg_value>from ui import\n  (\n      BUTTON_GRID, GRID_ROWS, GRID_COLS, CALC_WIDTH,\n      init_colors, draw_calc, check_screen_size, calc_center,\n  )</arg_value><arg_key>new_string</arg_key><arg_value>from ui import (\n      BUTTON_GRID, GRID_ROWS, GRID_COLS, CALC_WIDTH, CALC_HEIGHT,\n      init_colors, draw_calc, check_screen_size, calc_center,\n  )</arg_value>', "Edit", {"file_path": "/home/claude/api/app.py", "old_string": "from ui import\n  (\n      BUTTON_GRID, GRID_ROWS, GRID_COLS, CALC_WIDTH,\n      init_colors, draw_calc, check_screen_size, calc_center,\n  )", "new_string": "from ui import (\n      BUTTON_GRID, GRID_ROWS, GRID_COLS, CALC_WIDTH, CALC_HEIGHT,\n      init_colors, draw_calc, check_screen_size, calc_center,\n  )"}),
